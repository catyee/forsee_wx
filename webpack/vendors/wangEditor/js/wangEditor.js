    ...
    Txt.fn.bindHtml = function () {
        ...
        $txt.html = function (html) {
            ...
            if (html === undefined) {
				...
				html = html.replace( /<style editorstyle >(.*?)<\/style>/, '' );
            ...
            if (html === undefined) {
				...
				if( !E.config.useStyleSheet ){
					
					result = ( '<style editorstyle >' + E.config.stylesheet + '</style>' ) + result;
...
_e(function (E, $) {
    ...
    E.langs.en = {
		...
		showhiddenchar: 'Show hidden char',
        openLink: 'open link'
    };
});
// 全局配置
_e(function (E, $) {
	...
	//随内同发布的样式表
	E.config.stylesheet = 'table { border: none; border-collapse: collapse; } table td, table th { border: 1px solid #999; padding: 3px 5px; min-width:50px;height: 20px;}'
...
_e(function (E, $) {
    ...
    E.UI.menus = {
        ...
        preview: {
            normal: '<a href="#" tabindex="-1"><i class="wangeditor-menu-img-eye"></i></a>',
            selected: '.selected'
        },
        bold: {
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        menu.clickEvent = function (e) {
            ...
            var content = '<div style="width:1230px; margin:auto;">'+html+'</div>';
			console.log(html);
            window.open('javascript:document.write(\''+html+'\')',"_blank","width=1230px, scrollbars=yes, resizable=yes");
        };
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        var menu = new E.Menu({
            editor: editor,
            id: menuId,
            title: lang.pagebreak
        });

        // 定义click事件
        menu.clickEvent = function (e) {
			editor.command(e, 'insertHtml', '<div style="page-break-before:always;height:3px" class="page-breaker" contentEditable="false"></div>');
        };
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        menu.clickEvent = function (e) {
			console.log(editor);
			editor.$editorContainer.toggleClass('show-hidden-char');
